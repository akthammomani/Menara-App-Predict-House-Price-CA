...
icon = Image.open("C:/Users/aktha/menara_app/light_house.JPG")
...
image = Image.open("C:/Users/aktha/menara_app/house_5.JPG")
# let's specify which column, fix its width and let's give this image a caption:
row1_2.image(Image.open("C:/Users/aktha/menara_app/house_8.JPG"), use_column_width=True, caption='San Francisco - The Painted Ladies')
...
sqft = row2_3.number_input('Living Space - Sqft', min_value=381, max_value=5629, value=2215, help="Min=381, Max=5629")
median_price_sqft_cluster = row2_4.number_input('Median sqft Price',min_value=207, max_value=1072, value=480, help="Min=207, Max=1072")
...
median_income = row2_4.number_input('Annual Income', min_value=25000, max_value=300000, value=149500, help="Min=$25K, Max=$300K")
lot_size = row2_3.number_input('Lot Size', min_value=0, max_value=39987, value=2215, help="Min=0, Max=39987")
property_type = row2_3.selectbox('Property Type', ('Single Family Residential', 'Condo/Co-op', 'Townhouse'), index=2)
beds = row2_3.selectbox('Num of Bedrooms', (1, 2, 3, 4, 5, 6, 7, 8), index=3)
...
URL = ("C:/Users/aktha/menara_app/redfine_houses_sales_2012_2021.csv")
...
model = pkl.load(open("C:/Users/aktha/menara_app/Tuned_stacking_deploy_np.pkl", 'rb'))
...
DATA_URL = ("C:/Users/aktha/menara_app/GreatSchools_NCA_df_app_v2.csv")
